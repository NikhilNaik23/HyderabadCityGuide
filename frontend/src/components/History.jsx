...
const History = () => {
  ...
  `,
      ...
      src: "../src/assets/1984.png",
      textClassName: "text-lg leading-relaxed mt-6 ",
    },
  ];

  return (
    <div className="text-white bg-[#DFA16E] bg-[linear-gradient(138deg,_rgba(223,_161,_110,_1)_0%,_rgba(97,_50,_22,_1)_52%,_rgba(0,_0,_0,_1)_100%)]
